...
namespace Chess.Board
{
    public interface IPosition : ICloneable
    {
        ...
        public IPosition Copy(IPosition p);

        public IPosition Add(IPosition p0, IPosition p1);

        public IPosition Subtract(IPosition p0, IPosition p1);

        public IPosition Scale(IPosition p, int s);
